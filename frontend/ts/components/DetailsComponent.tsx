       ...
       const genres = this.props['data-genres'].map((genre, i) => {
        ...
        return (
            <div className="content-info">
                ...
                {this.props['data-theaters'] ? <div><b>In Theaters:</b> {parseDate(this.props['data-theaters'])}</div> : ''}
                {this.props['data-premiere'] ? <div><b>Premiere Date:</b> {parseDate(this.props['data-premiere'])}</div> : ''}
