...
import { parseMedia, parseUserMedia } from "../../HelperFunctions";
    ...
    render() {
        ...
        const photos = state.media.filter(photo => photo.type == 'PHOTO').map((photo, i) => {
            return <div className="search-item">
                <img className="no-padding" src={parseMedia(photo)}/> 
        ...
        const cast = state.cast.map((castPerson, i) => {
            return <div className="cast-person" key={i}>
                <img className="img-align-left" src={parseUserMedia(castPerson.celebrity.profilePicture)}/>
