      ...
      return Celebrity
          ...
          .media(Media
              ...
              .photos(new ImmutableList.Builder<URL>()
                  .add(new URL("https://static1.squarespace.com/static/51b3dc8ee4b051b96ceb10de/t/5a985315ec212d62633aa2ff/1519932184830/?format=1500w"))
                  .add(new URL("http://freshwallpapers.net/download/9313/1024x1024/download/chadwick-boseman-gods-of-egypt.jpg"))
                  .add(new URL("https://img.huffingtonpost.com/asset/59de722b140000a6234944ef.jpeg"))
                  .add(new URL("https://cdn1.thr.com/sites/default/files/imagecache/landscape_928x523/2016/02/message_from_the_king_still.jpg"))
                  .build())
